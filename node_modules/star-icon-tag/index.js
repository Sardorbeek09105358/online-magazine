...
var normalize = exports.normalize = function normalize(svg) {
	...
	var dom = arguments.length <= 2 || arguments[2] === undefined ? document : arguments[2];
...
var register = exports.register = function register() {
	...
	var opts = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	var dom = arguments.length <= 1 || arguments[1] === undefined ? document : arguments[1];

	var svg = dom.createElementNS(xmlns, 'svg');
