              ...
              <div className="flex gap-x-8 h-96">
                ...
                <div className="flex-1 flex flex-col">
                  <div className="flex-1">
                    ...
                    <p className="line-clamp text-sm">{product?.description}</p>
                  </div>
                  <div className="space-y-3 text-sm">
                    <button className="button w-full bg-blue-600 text-white border-transparent hover:border-blue-600 hover:bg-transparent hover:text-black" onClick={handleClick} >add to back</button>
                    <button  onClick={() => window.location.reload()} className="button w-full bg-transparent border-blue-600 hover:bg-blue-600 hover:text-white hover:border-transparent">wiew full details</button>
                  </div>
                </div>
              </div>
            )}
